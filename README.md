...
<h4 align="center">An offline physically based renderer. <a href="https://jotrocken.blog/" target="_blank"></a>.</h4>
...
There is a high demand in high-performance offline graphic applications.
...
1. Clone the repo
   ```sh
   git clone git@github.com:Kataglyphis/PBR.git
   ```
